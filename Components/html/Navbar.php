...
<nav class="bg-red-300 border-gray-200 dark:bg-red-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        ...
        <div class="flex items-center md:order-2">
            <?php 
                session_start();
                if(!key_exists("nome", $_SESSION)){ ?>
            <a href="#" swks-modal-target="authentication-modal" swks-modal-toggle="authentication-modal" class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Login</a>
            <a href="#" swks-modal-target="registration-modal" swks-modal-toggle="registration-modal" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Registre-se</a>
                <?php } ?>
